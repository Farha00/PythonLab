...
button1=Button(window,width=10,text="Load Pickle",bg='#FF5733',command=loadFile)
button1.grid(row=2,column=4)

button8=Button(window,width=10,text="Filter",bg='#FF5733',command=filterList)
button8.grid(row=2,column=5)

#second section 

button2=Button(window,width=10,text="Add",bg='#FF5733',command=addList)
button2.grid(row=0,column=4)

button4=Button(window,width=10,text="Delete",bg='#FF5733',command=delete)
button4.grid(row=1,column=4)

button5=Button(window,width=10,text="Sort Mileage",bg='#FF5733',command=sortMileage)
button5.grid(row=1,column=5)


button7=Button(window,width=10,text="Create Pickle",bg='#FF5733',command=createPickle)
